...
class RoboLabPlanetTests(unittest.TestCase):
    ...
    def test_empty_planet(self):
        ...
        """
        empty_planet = Planet_3() #initializes an empty planet 
    ...
    def test_same_length(self):
        ...
        self.assertEqual(test_shortest_path_1[0], ((1, 1), Direction.NORTH))     
        self.assertEqual(test_shortest_path_1[1], ((1, 2), Direction.EAST))
        self.assertEqual(test_shortest_path_1[2], ((2, 3), Direction.NORTH))
